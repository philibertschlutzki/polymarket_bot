...
try:
    ...
    CET_TZ: ZoneInfo | timezone = ZoneInfo("Europe/Berlin")
except ImportError:
...
def _generate_header(capital, metrics, now_cet):
    ...
    return f"""# 📊 Polymarket AI Bot - Performance Dashboard
...
def _generate_gemini_usage():
    ...
    usage_section = f"""## 🤖 Gemini API Usage
...
def _generate_risk_metrics(active_bets, capital):
    ...
    return f"""## ⚖️ Portfolio Risk Metrics
...
def _generate_calibration_section(analytics_advanced, results):
    ...
    section = """## 🎯 AI Confidence Calibration
...
"""
    ...
    score_icon = "🟢" if overall >= 0.90 else "🟡" if overall >= 0.80 else "🔴"
